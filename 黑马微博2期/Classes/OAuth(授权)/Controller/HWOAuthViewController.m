...
- (void)viewDidLoad
{
    ...
    */
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=1415797734&redirect_uri=http://www.baidu.com"];
...
//    mgr.responseSerializer = [AFJSONResponseSerializer serializer];
    ...
    params[@"client_id"] = @"1415797734";
    params[@"client_secret"] = @"7e0736e5fba984fd1dd7e49eec96549b";
